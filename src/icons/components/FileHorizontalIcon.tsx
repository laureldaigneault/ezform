...
export type FileHorizontalIconProps = CustomProps & import('react').ComponentPropsWithoutRef<'svg'>;

const StyledIcon = styled('svg')<FileHorizontalIconProps>(({ theme, ...props }) => {
  return {
    userSelect: 'none',
