  ...
  return (
    <StyledIcon
      ...
      <g>
        ...
        />
        <path
          d='M12 17C11.1307 17 10.3886 17.5551 10.1135 18.3332L9.7803 19.2761L7.89462 18.6096L8.22787 17.6668C8.7765 16.1145 10.2568 15 12 15C13.7432 15 15.2235 16.1145 15.7721 17.6668L16.1054 18.6096L14.2197 19.2761L13.8865 18.3332C13.6114 17.5551 12.8693 17 12 17Z'
          fill='currentcolor'
        />
        <path
          fillRule='evenodd'
