...
export type LocationArrowIconProps = CustomProps & import('react').ComponentPropsWithoutRef<'svg'>;

const StyledIcon = styled('svg')<LocationArrowIconProps>(({ theme, ...props }) => {
  return {
    userSelect: 'none',
