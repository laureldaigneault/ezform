...
export type DiagramSankeyIconProps = CustomProps & import('react').ComponentPropsWithoutRef<'svg'>;

const StyledIcon = styled('svg')<DiagramSankeyIconProps>(({ theme, ...props }) => {
  return {
    userSelect: 'none',
