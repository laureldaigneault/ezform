...
export type CornerUpRightIconProps = CustomProps & import('react').ComponentPropsWithoutRef<'svg'>;

const StyledIcon = styled('svg')<CornerUpRightIconProps>(({ theme, ...props }) => {
  return {
    userSelect: 'none',
