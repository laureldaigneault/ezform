...
export type DiagramNestedIconProps = CustomProps & import('react').ComponentPropsWithoutRef<'svg'>;

const StyledIcon = styled('svg')<DiagramNestedIconProps>(({ theme, ...props }) => {
  return {
    userSelect: 'none',
