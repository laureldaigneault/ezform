...
export default function FileCodeIcon({ className = '', ...props }: FileCodeIconProps): React.ReactElement {
  return (
    <StyledIcon
      ...
      fill='none'>
      <g>
        <path d='M11.4142 14L9.41421 16L11.4142 18L10 19.4142L6.58579 16L10 12.5858L11.4142 14Z' fill='currentcolor' />
        <path d='M14 12.5858L17.4142 16L14 19.4142L12.5858 18L14.5858 16L12.5858 14L14 12.5858Z' fill='currentcolor' />
        <path
          fillRule='evenodd'
          clipRule='evenodd'
