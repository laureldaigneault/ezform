...
export default function UserShieldIcon({ className = '', ...props }: UserShieldIconProps): React.ReactElement {
  ...
  return (
    <StyledIcon
      ...
      fill="none">
      <g>
        <path fillRule="evenodd" clipRule="evenodd" d="M7 6C7 3.23858 9.23858 1 12 1C14.7614 1 17 3.23858 17 6C17 8.76142 14.7614 11 12 11C9.23858 11 7 8.76142 7 6ZM12 3C10.3431 3 9 4.34315 9 6C9 7.65685 10.3431 9 12 9C13.6569 9 15 7.65685 15 6C15 4.34315 13.6569 3 12 3Z" fill="currentcolor"/><path d="M4.06189 21C4.55399 17.0537 7.92038 14 12 14C12.4302 14 12.8517 14.0339 13.2623 14.0989L14.25 14.2553L14.5628 12.2799L13.5751 12.1235C13.0614 12.0421 12.5353 12 12 12C6.47715 12 2 16.4772 2 22V23H14.1908V21H4.06189Z" fill="currentcolor"/><path fillRule="evenodd" clipRule="evenodd" d="M19 13.5404L19.7284 14.3149C20.2616 14.8818 20.8969 15.1667 21.625 15.1667H23V17.3979C23 19.9614 21.5185 22.2756 19.2924 22.9563L19 23.0457L18.7076 22.9563C16.4815 22.2756 15 19.9614 15 17.3979L15.0001 15.1667H16.375C17.1032 15.1667 17.7383 14.8818 18.2715 14.3149L19 13.5404ZM17 17.1249L17 17.3979C17 19.1125 17.9029 20.4397 19 20.9334C20.0971 20.4397 21 19.1125 21 17.3979V17.1253C20.2636 17.0254 19.5905 16.7486 19 16.3253C18.4095 16.7486 17.7364 17.025 17 17.1249Z" fill="currentcolor"/>
      </g>
    </StyledIcon>
  );
}
