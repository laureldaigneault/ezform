...
export default function PhoneIcon({ className = '', ...props }: PhoneIconProps): React.ReactElement {
  ...
  return (
    <StyledIcon
      ...
      fill="none">
      <g>
        <path fillRule="evenodd" clipRule="evenodd" d="M1 1H7.8198L9.08554 7.32867L6.41389 10.0003C7.44973 13.6627 10.3373 16.5503 13.9997 17.5861L16.6713 14.9145L23 16.1802V23H17C8.16344 23 1 15.8366 1 7V1ZM3 3V7C3 14.732 9.26801 21 17 21H21V17.8198L17.3287 17.0855L14.6198 19.7944L14.0803 19.6706C9.24414 18.5604 5.4396 14.7559 4.32939 9.9197L4.20555 9.38024L6.91446 6.67133L6.1802 3H3Z" fill="currentcolor"/>
      </g>
    </StyledIcon>
  );
}
