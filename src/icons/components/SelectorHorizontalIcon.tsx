...
export type SelectorHorizontalIconProps = CustomProps & import('react').ComponentPropsWithoutRef<'svg'>;

const StyledIcon = styled('svg')<SelectorHorizontalIconProps>(({ theme, ...props }) => {
  return {
    userSelect: 'none',
