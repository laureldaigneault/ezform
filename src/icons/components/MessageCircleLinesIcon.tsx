...
export default function MessageCircleLinesIcon({
  className = '',
  ...props
}: MessageCircleLinesIconProps): React.ReactElement {
  return (
    <StyledIcon
      viewBox='0 0 24 24'
      {...props}
      ...
      fill='none'>
      <g>
        <path d='M6.99985 9H16.9999V11H6.99985V9Z' fill='currentcolor' />
        <path d='M6.99985 13H11.9999V15H6.99985V13Z' fill='currentcolor' />
        <path
          fillRule='evenodd'
          clipRule='evenodd'
