...
export type MessageCircleBlankIconProps = CustomProps & import('react').ComponentPropsWithoutRef<'svg'>;

const StyledIcon = styled('svg')<MessageCircleBlankIconProps>(({ theme, ...props }) => {
  return {
    userSelect: 'none',
...
export default function MessageCircleBlankIcon({ className = '', ...props }: MessageCircleBlankIconProps): React.ReactElement {
