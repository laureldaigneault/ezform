...
export default function LocationExclamationIcon({
  className = '',
  ...props
}: LocationExclamationIconProps): React.ReactElement {
  return (
    <StyledIcon
      viewBox='0 0 24 24'
      {...props}
      ...
      fill='none'>
      <g>
        <path d='M13 5.5V11.5H11V5.5H13Z' fill='currentcolor' />
        <path d='M11 13.5H13.01V15.5H11V13.5Z' fill='currentcolor' />
        <path
          fillRule='evenodd'
          clipRule='evenodd'
