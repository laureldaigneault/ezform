...
export type BookmarkMinusIconProps = CustomProps & import('react').ComponentPropsWithoutRef<'svg'>;

const StyledIcon = styled('svg')<BookmarkMinusIconProps>(({ theme, ...props }) => {
  return {
    userSelect: 'none',
