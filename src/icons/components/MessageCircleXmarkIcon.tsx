...
export type MessageCircleXmarkIconProps = CustomProps & import('react').ComponentPropsWithoutRef<'svg'>;

const StyledIcon = styled('svg')<MessageCircleXmarkIconProps>(({ theme, ...props }) => {
  return {
    userSelect: 'none',
