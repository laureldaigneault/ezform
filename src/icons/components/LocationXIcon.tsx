...
export default function LocationXIcon({ className = '', ...props }: LocationXIconProps): React.ReactElement {
  return (
    <StyledIcon
      ...
      <g>
        <path
          d='M9.5 6.08579L12 8.58579L14.5 6.08579L15.9142 7.5L13.4142 10L15.9142 12.5L14.5 13.9142L12 11.4142L9.5 13.9142L8.08579 12.5L10.5858 10L8.08579 7.5L9.5 6.08579Z'
          fill='currentcolor'
        />
        <path
          fillRule='evenodd'
