...
export default function StaedtlerCompassIcon({
  className = '',
  ...props
}: StaedtlerCompassIconProps): React.ReactElement {
  return (
    <StyledIcon
      viewBox='0 0 24 24'
      {...props}
