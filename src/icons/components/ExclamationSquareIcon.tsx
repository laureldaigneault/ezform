...
export type ExclamationSquareIconProps = CustomProps & import('react').ComponentPropsWithoutRef<'svg'>;

const StyledIcon = styled('svg')<ExclamationSquareIconProps>(({ theme, ...props }) => {
  return {
    userSelect: 'none',
