...
export default function FolderQuestionIcon({ className = '', ...props }: FolderQuestionIconProps): React.ReactElement {
  return (
    <StyledIcon
      ...
      <g>
        <path
          d='M11.937 10.25C11.4724 10.25 11.0795 10.5677 10.9684 10.9993L10.7192 11.9677L8.7823 11.4692L9.03156 10.5007C9.36454 9.20704 10.5377 8.25 11.937 8.25C13.5938 8.25 14.937 9.59315 14.937 11.25C14.937 12.1814 14.4825 12.7993 14.0065 13.2587C13.8136 13.4449 13.594 13.6269 13.3966 13.7905C13.3675 13.8146 13.3389 13.8383 13.3109 13.8616C13.0805 14.0533 12.86 14.2413 12.6441 14.4571L11.937 15.1642L10.5228 13.75L11.2299 13.0429C11.5141 12.7587 11.7936 12.5223 12.0319 12.324C12.0635 12.2978 12.0939 12.2725 12.1234 12.248C12.328 12.0782 12.4832 11.9494 12.6175 11.8197C12.8915 11.5553 12.937 11.4232 12.937 11.25C12.937 10.6977 12.4893 10.25 11.937 10.25Z'
          fill='currentcolor'
        />
        <path d='M10.9375 15.25H12.9475V17.25H10.9375V15.25Z' fill='currentcolor' />
        <path
          fillRule='evenodd'
          clipRule='evenodd'
