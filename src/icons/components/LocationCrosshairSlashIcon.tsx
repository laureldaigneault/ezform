...
export default function LocationCrosshairSlashIcon({
  className = '',
  ...props
}: LocationCrosshairSlashIconProps): React.ReactElement {
  return (
    <StyledIcon
      viewBox='0 0 24 24'
      {...props}
