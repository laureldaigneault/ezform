...
export type CreditCardArrowRightIconProps = CustomProps & import('react').ComponentPropsWithoutRef<'svg'>;

const StyledIcon = styled('svg')<CreditCardArrowRightIconProps>(({ theme, ...props }) => {
  return {
    userSelect: 'none',
