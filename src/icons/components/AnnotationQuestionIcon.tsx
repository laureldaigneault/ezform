...
export default function AnnotationQuestionIcon({
  className = '',
  ...props
}: AnnotationQuestionIconProps): React.ReactElement {
  return (
    <StyledIcon
      viewBox='0 0 24 24'
      {...props}
      ...
      <g>
        ...
        <path
          fillRule='evenodd'
          clipRule='evenodd'
          d='M2 2H22V20H15.7552L12 23.338L8.2448 20H2V2ZM4 4V18H8.625L9.28936 18.2526L12 20.662L14.7106 18.2526L15.375 18H20V4H4Z'
          fill='currentcolor'
        />
      </g>
    </StyledIcon>
