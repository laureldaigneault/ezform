...
export type BitcoinCircleIconProps = CustomProps & import('react').ComponentPropsWithoutRef<'svg'>;

const StyledIcon = styled('svg')<BitcoinCircleIconProps>(({ theme, ...props }) => {
  return {
    userSelect: 'none',
