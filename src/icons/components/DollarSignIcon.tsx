    ...
    <StyledIcon
      ...
      <g>
        <path
          fillRule='evenodd'
          clipRule='evenodd'
          d='M13 1V4H18V6H13V11H14.5C16.9853 11 19 13.0147 19 15.5C19 17.9853 16.9853 20 14.5 20H13V23H11V20H5V18H11V13H9.5C7.01472 13 5 10.9853 5 8.5C5 6.01472 7.01472 4 9.5 4H11V1H13ZM11 6H9.5C8.11929 6 7 7.11929 7 8.5C7 9.88071 8.11929 11 9.5 11H11V6ZM13 13V18H14.5C15.8807 18 17 16.8807 17 15.5C17 14.1193 15.8807 13 14.5 13H13Z'
          fill='currentcolor'
        />
      </g>
    </StyledIcon>
