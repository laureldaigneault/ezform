    ...
    <StyledIcon
      ...
      <g>
        <path
          fillRule='evenodd'
          clipRule='evenodd'
          d='M18 0.375L23.6667 11H12.3333L18 0.375ZM15.6667 9H20.3333L18 4.625L15.6667 9Z'
          fill='currentcolor'
        />
        <path fillRule='evenodd' clipRule='evenodd' d='M1 1H11V11H1V1ZM3 3V9H9V3H3Z' fill='currentcolor' />
        <path
          fillRule='evenodd'
          clipRule='evenodd'
          ...
          fill='currentcolor'
        />
        <path d='M13 13H23V15H13V13Z' fill='currentcolor' />
        <path d='M13 17H23V19H13V17Z' fill='currentcolor' />
        <path d='M13 21H23V23H13V21Z' fill='currentcolor' />
      </g>
    </StyledIcon>
  );
}
