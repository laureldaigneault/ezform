    ...
    <StyledIcon
      ...
      <g>
        <path
          fillRule='evenodd'
          clipRule='evenodd'
          d='M8 13C8 10.7909 9.79086 9 12 9C14.2091 9 16 10.7909 16 13C16 15.2091 14.2091 17 12 17C9.79086 17 8 15.2091 8 13ZM12 11C10.8954 11 10 11.8954 10 13C10 13.1792 10.0236 13.3528 10.0677 13.518L12.518 11.0677C12.3528 11.0236 12.1792 11 12 11ZM13.9323 12.482L11.482 14.9323C11.6472 14.9764 11.8208 15 12 15C13.1046 15 14 14.1046 14 13C14 12.8208 13.9764 12.6472 13.9323 12.482Z'
          fill='currentcolor'
        />
        <path
          fillRule='evenodd'
