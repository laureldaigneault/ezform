...
export type DistributeSpacingHorizontalIconProps = CustomProps & import('react').ComponentPropsWithoutRef<'svg'>;

const StyledIcon = styled('svg')<DistributeSpacingHorizontalIconProps>(({ theme, ...props }) => {
  return {
    userSelect: 'none',
