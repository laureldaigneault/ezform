...
export type ArrowTopRightOnSquareIconProps = CustomProps & import('react').ComponentPropsWithoutRef<'svg'>;

const StyledIcon = styled('svg')<ArrowTopRightOnSquareIconProps>(({ theme, ...props }) => {
  return {
    userSelect: 'none',
