  ...
  return (
    <StyledIcon
      ...
      <g>
        ...
        />
        <path
          d='M4.06189 21C4.55399 17.0537 7.92038 14 12 14C12.8952 14 13.7541 14.1467 14.5553 14.4165L15.503 14.7357L16.1413 12.8403L15.1936 12.5211C14.1895 12.1829 13.1151 12 12 12C6.47715 12 2 16.4772 2 22V23H11V21H4.06189Z'
          fill='currentcolor'
        />
        <path
          fillRule='evenodd'
