...
export default function TowerBroadcastSlashIcon({
  className = '',
  ...props
}: TowerBroadcastSlashIconProps): React.ReactElement {
  return (
    <StyledIcon
      viewBox='0 0 24 24'
      {...props}
      ...
      fill='none'>
      <g>
        <g clipPath='url(#clip0_1718_1639)'>
          <path
            fillRule='evenodd'
            clipRule='evenodd'
          ...
          <path
            ...
            fill='currentcolor'
          />
          <path d='M13.0004 16.5999V22H11.0004V16.5999H13.0004Z' fill='currentcolor' />
        </g>
        <defs>
