...
export type ArrowNarrowDownIconProps = CustomProps & import('react').ComponentPropsWithoutRef<'svg'>;

const StyledIcon = styled('svg')<ArrowNarrowDownIconProps>(({ theme, ...props }) => {
  return {
    userSelect: 'none',
