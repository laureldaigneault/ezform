...
export default function MessageSquareRefreshIcon({
  className = '',
  ...props
}: MessageSquareRefreshIconProps): React.ReactElement {
  return (
    <StyledIcon
      viewBox='0 0 24 24'
      {...props}
