...
export type SelectorVerticalIconProps = CustomProps & import('react').ComponentPropsWithoutRef<'svg'>;

const StyledIcon = styled('svg')<SelectorVerticalIconProps>(({ theme, ...props }) => {
  return {
    userSelect: 'none',
