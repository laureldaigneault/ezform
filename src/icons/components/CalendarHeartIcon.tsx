    ...
    <StyledIcon
      ...
      <g>
        <path
          fillRule='evenodd'
          clipRule='evenodd'
          d='M11.997 11.433C10.9974 10.8394 9.68367 10.7979 8.62297 11.661C7.32953 12.7135 7.11986 14.5349 8.16768 15.819L8.2127 15.8742L11.9976 19.3594L15.7825 15.8742L15.8275 15.819C16.8659 14.5465 16.6948 12.7078 15.3617 11.6526C14.2966 10.8095 12.9947 10.8402 11.997 11.433ZM11.2536 13.3801C10.8531 12.9342 10.2851 12.887 9.88531 13.2123C9.44286 13.5724 9.39149 14.1081 9.68101 14.5075L11.9976 16.6406L14.3145 14.5072C14.6126 14.0976 14.5541 13.564 14.1204 13.2208C13.695 12.884 13.1348 12.9423 12.7416 13.3801L11.9976 14.2085L11.2536 13.3801Z'
          fill='currentcolor'
        />
        <path
          fillRule='evenodd'
