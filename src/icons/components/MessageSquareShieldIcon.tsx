...
export default function MessageSquareShieldIcon({
  className = '',
  ...props
}: MessageSquareShieldIconProps): React.ReactElement {
  return (
    <StyledIcon
      viewBox='0 0 24 24'
      {...props}
