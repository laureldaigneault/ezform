...
export type ArrowLeftTrayIconProps = CustomProps & import('react').ComponentPropsWithoutRef<'svg'>;

const StyledIcon = styled('svg')<ArrowLeftTrayIconProps>(({ theme, ...props }) => {
  return {
    userSelect: 'none',
