...
export type ObjectsAlignCenterHorizontalIconProps = CustomProps & import('react').ComponentPropsWithoutRef<'svg'>;

const StyledIcon = styled('svg')<ObjectsAlignCenterHorizontalIconProps>(({ theme, ...props }) => {
  return {
    userSelect: 'none',
