...
export default function KeyIcon({ className = '', ...props }: KeyIconProps): React.ReactElement {
  return (
    <StyledIcon
      ...
      fill='none'>
      <g>
        <path d='M15 7H17.01V9H15V7Z' fill='currentcolor' />
        <path
          fillRule='evenodd'
          clipRule='evenodd'
          d='M9 8C9 4.13401 12.134 1 16 1C19.866 1 23 4.13401 23 8C23 11.866 19.866 15 16 15C15.508 15 15.0269 14.9491 14.5622 14.852L12.4142 17H11V19H9V21H7V23H1V17.5858L9.14801 9.43778C9.05092 8.97307 9 8.49204 9 8ZM9 17V15H11.5858L13.9737 12.6121L14.5471 12.7859C15.0057 12.9249 15.4932 13 16 13C18.7614 13 21 10.7614 21 8C21 5.23858 18.7614 3 16 3C13.2386 3 11 5.23858 11 8C11 8.50683 11.0751 8.99431 11.2141 9.45287L11.3879 10.0263L3 18.4142V21H5V19H7V17H9Z'
          fill='currentcolor'
        />
      </g>
    </StyledIcon>
