...
export type CalendarArrowDownIconProps = CustomProps & import('react').ComponentPropsWithoutRef<'svg'>;

const StyledIcon = styled('svg')<CalendarArrowDownIconProps>(({ theme, ...props }) => {
  return {
    userSelect: 'none',
